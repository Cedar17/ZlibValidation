...
- **C++ Compiler:** C++20 standard support required (e.g., GCC >= 10, Clang >= 12). Developed with GCC 14.2.0.
- **CMake:** Version 3.25 or higher (used for configuring the build).
...
3. **Compile the project:**
    ...
    ninja
    # or if you used Make:
    make -j$(nproc) # Adjust $(nproc) or use a specific number like -j4
    ```
